...
LightCsrfSimpleService::startSession
================



LightCsrfSimpleService::startSession — Ensures that the php session has started.
...
protected [LightCsrfSimpleService::startSession](https://github.com/lingtalfi/Light_CsrfSimple/blob/master/doc/api/Ling/Light_CsrfSimple/Service/LightCsrfSimpleService/startSession.md)() : void
